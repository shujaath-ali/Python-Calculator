...
btn_divide = tk.Button(root, text="/", command=lambda: add_to_calc("/"), width=5, font=("Arial", 14))
btn_divide.grid(row=5, column=4)
btn_opnbrace = tk.Button(root, text="(", command=lambda: add_to_calc("("), width=5, font=("Arial", 14))
btn_opnbrace.grid(row=5, column=1)
btn_closebrace = tk.Button(root, text=")", command=lambda: add_to_calc(")"), width=5, font=("Arial", 14))
btn_closebrace.grid(row=5, column=3)
btn_equal = tk.Button(root, text="=", command=evaluate_calc, width=11, font=("Arial", 14))
btn_equal.grid(row=6, column=3, columnspan=2)
btn_clr = tk.Button(root, text="Clear", command=clear_field, width=11, font=("Arial", 14))
